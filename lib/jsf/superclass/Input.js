  ...
  _createClass(Input, [
    {
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      _context2.next = 2;
                      return _get(Input.prototype.__proto__ ||
                          Object.getPrototypeOf(Input.prototype), 'jsfOnRender',
                          this).call(this);
      ...
      value: function() {
        var _ref4 = _asyncToGenerator(/*#__PURE__*/
            regeneratorRuntime.mark(function _callee4() {
              var hasError, message, currentValue, _iteratorNormalCompletion,
                  _didIteratorError, _iteratorError, _iterator, _step, child,
                  response;
                  ...
                  switch (_context4.prev = _context4.next) {
                    ...
                    case 24:
                      ...
                      if (this.props.maxLength && !hasError) {
                        if (currentValue &&
                            currentValue.length > this.props.maxLength) {
                          hasError = true;
                          message = 'Max ' + this.props.maxLength +
                              ' Characters allowed';
                        }
                      }
      ...
      get: function get() {
        ...
        var value = typeof this.props.value === 'string' ?
