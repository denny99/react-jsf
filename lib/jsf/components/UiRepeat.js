...
var UiRepeat = function(_React$Component) {
  ...
  function UiRepeat(props, context) {
    ...
    return _possibleConstructorReturn(this,
        (UiRepeat.__proto__ || Object.getPrototypeOf(UiRepeat)).call(this,
            props, context));
  }
      ...
      value: function render() {
        ...
        for (var i = 0; i < this.props.value.length; i++) {
          ...
          for (var j = 0; j < children.length; j++) {
            ...
            subChildren.push(_react2.default.cloneElement(
                _VarInjector2.default.inject(child, this.props.var, obj), {
                  key: '' + i + j,
                }));
          }
