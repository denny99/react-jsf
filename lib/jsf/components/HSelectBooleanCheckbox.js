...
var HSelectBooleanCheckbox = function(_Input) {
  ...
  function HSelectBooleanCheckbox() {
    ...
    return _possibleConstructorReturn(this, (HSelectBooleanCheckbox.__proto__ ||
        Object.getPrototypeOf(HSelectBooleanCheckbox)).apply(this, arguments));
  }
  ...
  _createClass(HSelectBooleanCheckbox, [
    {
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      _context2.next = 2;
                      return _get(HSelectBooleanCheckbox.prototype.__proto__ ||
                          Object.getPrototypeOf(
                              HSelectBooleanCheckbox.prototype), 'handleChange',
                          this).call(this, {
                        target: {
      ...
      value: function render() {
        return _react2.default.createElement('input', {
          className: this.props.styleClass, id: this.state.id,
          name: this.state.id,
          type: 'checkbox', onChange: this.handleChange, onBlur: this.validate,
