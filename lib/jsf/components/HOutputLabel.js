...
var HOutputLabel = function (_JsfElement) {
  _inherits(HOutputLabel, _JsfElement);

  function HOutputLabel() {
    _classCallCheck(this, HOutputLabel);

    return _possibleConstructorReturn(this, (HOutputLabel.__proto__ || Object.getPrototypeOf(HOutputLabel)).apply(this, arguments));
  }

  _createClass(HOutputLabel, [{
    key: 'render',
    value: function render() {
      var forId = this.context ? this.context.getFormId(this.props.for) : this.props.for;
