...
var HMessage = function (_JsfElement) {
  ...
  function HMessage(props, context) {
    ...
    return _possibleConstructorReturn(this, (HMessage.__proto__ || Object.getPrototypeOf(HMessage)).call(this, props, context));
  }

  _createClass(HMessage, [{
    key: 'render',
    value: function render() {
      var input = this.context.getInput(this.props.for);
      var show = input.hasError;
      return _react2.default.createElement(
        'span',
        { className: show ? this.props.styleClass : '',
          id: this.state.id },
        show ? input.errorMessage : _react2.default.createElement('span', { id: this.state.id })
      );
    }
  }]);
