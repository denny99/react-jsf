...
var HMessage = function (_JsfElement) {
  ...
  function HMessage(props, context) {
    ...
    var _this = _possibleConstructorReturn(this, (HMessage.__proto__ || Object.getPrototypeOf(HMessage)).call(this, props, context));
  ...
  _createClass(HMessage, [{
    ...
    value: function render() {
      ...
      var show = props.show && (this.context.activeElement === this.props.for || this.context.activeElement === 'all');
      return _react2.default.createElement(
        'span',
        { className: show ? this.props.styleClass : '',
          id: this.state.id },
        show ? props.message : _react2.default.createElement('span', { id: this.state.id })
      );
    }
  }]);
