...
var IcePanelGroup = function(_JsfElement) {
  ...
  function IcePanelGroup(props, context) {
    ...
    var _this = _possibleConstructorReturn(this,
        (IcePanelGroup.__proto__ || Object.getPrototypeOf(IcePanelGroup)).call(
            this, props, context));
  ...
  _createClass(IcePanelGroup, [
    {
      ...
      value: function onMouseOver(event) {
        if (this.props.panelTooltip) {
          new ToolTipPanelPopup(this.div,
              this.context.getFormId(this.props.panelTooltip),
              event.nativeEvent, 'mouseout', '500', 'false',
