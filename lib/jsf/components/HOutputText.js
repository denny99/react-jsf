...
var _JsfElement = require('../superclass/JsfElement');

var _JsfElement2 = _interopRequireDefault(_JsfElement);
...
var HOutputText = function(_Output) {
  ...
  function HOutputText() {
    ...
    return _possibleConstructorReturn(this,
        (HOutputText.__proto__ || Object.getPrototypeOf(HOutputText)).apply(
            this, arguments));
  }
      ...
      value: function render() {
        if (this.props.rendered !== false) {
          return _react2.default.createElement(
              ...
              this.props.value !== undefined ? this.value : this.props.children,
          );
        }
        return null;
      },
