  ...
  _createClass(Row, [
    {
      ...
      value: function render() {
        ...
        for (var i = 0, j = this.props.children.length; i < j; i++) {
          ...
          var convertedColumn = _VarInjector2.default.inject(column,
              this.props.varName, this.props.var);
        ...
        return _react2.default.createElement(
            'tr',
            {
              className: this.props.index % 2 === 0 ?
                  'ui-datatable-even' :
                  'ui-datatable-odd',
              id: this.props.parentId + '_row_' +
              (this.props.currentPage * this.props.pageSize + this.props.index),
              tabIndex: '0',
            },
            columns,
        );
