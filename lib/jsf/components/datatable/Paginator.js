...
var Paginator = function(_React$Component) {
  ...
  function Paginator() {
    ...
    return _possibleConstructorReturn(this,
        (Paginator.__proto__ || Object.getPrototypeOf(Paginator)).apply(this,
            arguments));
  }
  ...
  _createClass(Paginator, [
    {
      ...
      value: function render() {
        ...
        var firstLink = this.props.currentPage === 1 ?
            ...
            _react2.default.createElement(
                'a',
                {
                  id: 'yui-pg1-0-first-link',
                  href: '#',
                  onClick: this.context.first,
        ...
        var prevLink = this.props.currentPage === 1 ?
            _react2.default.createElement(
                'span',
                {
        ...
        var nextLink = this.props.currentPage === maxPage ?
            _react2.default.createElement(
                'span',
                {
        ...
        var lastLink = this.props.currentPage === maxPage ?
            _react2.default.createElement(
                'span',
                {
            ...
            _react2.default.createElement(
                'a',
                {
                  id: 'yui-pg0-0-last-link',
                  href: '#',
                  onClick: this.context.last,
        ...
        var startPage = Math.max(1, this.props.currentPage -
            (this.props.currentPage + 5 > maxPage ?
                9 - (maxPage - this.props.currentPage) :
                5));
        var endPage = Math.min(maxPage,
        ...
        return _react2.default.createElement(
            'div',
            {
              className: 'ui-paginator ' +
              (this.props.top ? 'ui-paginator-top' : 'ui-paginator-bottom') +
              ' ui-widget-header ui-corner-tl ui-corner-tr',
              id: 'datatableForm:flightsTable_paginator' +
