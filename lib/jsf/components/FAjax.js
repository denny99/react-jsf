...
var FAjax = function (_React$Component) {
  ...
  function FAjax(props, context) {
    ...
    var _this = _possibleConstructorReturn(this, (FAjax.__proto__ || Object.getPrototypeOf(FAjax)).call(this, props, context));
  ...
  _createClass(FAjax, [{
    key: 'call',
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(caller) {
        var obj, renderElem;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = _context.t0 === '@form' ? 5 : _context.t0 === '@all' ? 7 : 9;
                break;
              ...
              case 11:
                ...
                _context.next = _context.t1 === '@all' ? 14 : _context.t1 === '@form' ? 16 : _context.t1 === '@this' ? 18 : 18;
                break;
