...
var HCommandButton = function(_JsfElement) {
  ...
  function HCommandButton(props, context) {
    ...
    var _this = _possibleConstructorReturn(this, (HCommandButton.__proto__ ||
        Object.getPrototypeOf(HCommandButton)).call(this, props, context));
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      _context.next = 4;
                      return this.context.form.validate();
...
HCommandButton.propTypes = {
  ...
  actionArgument: _propTypes2.default.oneOfType(
