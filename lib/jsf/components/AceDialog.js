...
var AceDialog = function (_JsfElement) {
  ...
  function AceDialog(props, context) {
    ...
    var _this = _possibleConstructorReturn(this, (AceDialog.__proto__ || Object.getPrototypeOf(AceDialog)).call(this, props, context));
  ...
  _createClass(AceDialog, [{
    ...
    value: function render() {
      ...
      var style = {
        left: this.state.width ? window.innerWidth / 2 - this.state.width / 2 : 0,
        top: this.state.height ? window.innerHeight / 2 - this.state.height / 2 : 0
      };
      style = _.merge(style, this.state.visible ? AceDialog.visibleStyle : AceDialog.invisibleStyle);
      return _react2.default.createElement(
        'div',
        { id: this.state.id },
        this.state.visible ? _react2.default.createElement('div', { className: 'ui-widget-overlay', style: {
