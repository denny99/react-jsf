...
var AceTooltip = function (_JsfElement) {
  ...
  function AceTooltip(props, context) {
    ...
    var _this = _possibleConstructorReturn(this, (AceTooltip.__proto__ || Object.getPrototypeOf(AceTooltip)).call(this, props, context));
      ...
      this.tooltip = new ice.ace.Tooltip(this.state.id, {
        ...
        show: {
          effect: function effect(offset) {
            this.toggle(self.showEffect, self.showEffectOptions, self.props.showEffectLength); // "this" refers to the tooltip
          },
        ...
        hide: {
          effect: function effect(offset) {
            this.toggle(self.hideEffect, self.hideEffectOptions, self.props.hideEffectLength); // "this" refers to the tooltip
          },
