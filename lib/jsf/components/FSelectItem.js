...
var FSelectItem = function (_React$Component) {
  ...
  function FSelectItem(props, context) {
    ...
    var _this = _possibleConstructorReturn(this, (FSelectItem.__proto__ || Object.getPrototypeOf(FSelectItem)).call(this, props));
  ...
  _createClass(FSelectItem, [{
    ...
    value: function render() {
      var radioId = this.context.getFormId(Math.floor(Math.random() * 1000000));
      var radio = _react2.default.createElement(
        ...
        _react2.default.createElement(
          'td',
          null,
          _react2.default.createElement('input', { checked: this.context.currentValue() === this.props.value,
            id: radioId,
      ...
      var option = _react2.default.createElement(
        'option',
        {
          value: this.props.noSelectionOption ? '' : this.props.value || this.props.itemLabel },
        this.props.itemLabel
      );
      return this.context.parent instanceof _HSelectOneMenu2.default ? option : radio;
    }
  }]);
