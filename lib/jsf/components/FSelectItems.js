...
var FSelectItems = function(_React$Component) {
  ...
  function FSelectItems() {
    ...
    return _possibleConstructorReturn(this,
        (FSelectItems.__proto__ || Object.getPrototypeOf(FSelectItems)).apply(
            this, arguments));
  }
  ...
  _createClass(FSelectItems, [
    {
      ...
      value: function render() {
        var options = this.props.value.map(function(item, i) {
          return _react2.default.createElement(_FSelectItem2.default,
              {key: i, value: item.value, itemLabel: item.label});
        });
...
FSelectItems.propTypes = {
  value: _propTypes2.default.arrayOf(
      _propTypes2.default.instanceOf(_SelectItem2.default)).isRequired,
};
