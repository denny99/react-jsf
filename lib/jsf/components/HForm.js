...
var HForm = function (_JsfCore) {
  ...
  function HForm(props, context) {
    ...
    var _this = _possibleConstructorReturn(this, (HForm.__proto__ || Object.getPrototypeOf(HForm)).call(this, props, context));
  ...
  _createClass(HForm, [{
    ...
    value: function property(propertyName, value) {
      var result = _ObjectTraverser2.default.traverse(this.state.data, propertyName, value);
    ...
    key: 'validate',
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(skipInputs) {
    ...
    key: 'jsfOnRender',
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(skipChildren) {
