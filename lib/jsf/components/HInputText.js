...
var HInputText = function (_Input) {
  ...
  function HInputText() {
    ...
    return _possibleConstructorReturn(this, (HInputText.__proto__ || Object.getPrototypeOf(HInputText)).apply(this, arguments));
  }
  ...
  _createClass(HInputText, [{
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _get(HInputText.prototype.__proto__ || Object.getPrototypeOf(HInputText.prototype), 'componentDidMount', this).call(this);
    ...
    value: function render() {
      ...
      var elem = _react2.default.createElement('input', { id: this.state.id,
        name: this.state.id,
