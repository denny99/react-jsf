...
var _ApiResponse = require('../entity/ApiResponse');
...
var AceDataTable = function (_JsfElement) {
  ...
  function AceDataTable(props, context) {
    ...
    var _this = _possibleConstructorReturn(this, (AceDataTable.__proto__ || Object.getPrototypeOf(AceDataTable)).call(this, props, context));
  ...
  _createClass(AceDataTable, [{
    ...
    value: function render() {
      ...
      var paginatorTop = this.props.paginator ? _react2.default.createElement(_Paginator2.default, { top: true,
        pageSize: this.props.rows,
        currentPage: this.currentPage,
        maxResults: this.props.value.max }) : null;
      var paginatorBottom = this.props.paginator ? _react2.default.createElement(_Paginator2.default, { pageSize: this.props.rows, top: false,
        currentPage: this.currentPage,
        maxResults: this.props.value.max }) : null;
      var headers = [];
      var columns = [];
      ...
      _react2.default.Children.forEach(this.props.children, function (child, i) {
        if (child.type === _AceColumn2.default) {
          var column = new child.type(child.props, _this2.getChildContext());
